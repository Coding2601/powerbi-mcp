...
{
    public class GrandTotalDisabled : IIssueDataGenerator
    {
        public SingleIssueRuleData GetData(IssueContext issueContext)
        {
            var tempIssueData = issueContext.ReportDocumentation?.ReportUIFormatting.TableOrMatrixList.Where(x =>
               x.IsGrandTotalDisabled == true || x.IsRowGrandTotalDisabled == true || x.IsColumnGrandTotalDisabled == true
           );
