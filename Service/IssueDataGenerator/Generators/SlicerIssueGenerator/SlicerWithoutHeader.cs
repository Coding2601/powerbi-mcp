...
{
    public class SlicerWithoutHeader : IIssueDataGenerator
    {
        public SingleIssueRuleData GetData(IssueContext issueContext)
        {
            var tempIssueData = issueContext.ReportDocumentation?.ReportUIFormatting.SlicersList.Where(x => x.IsHeaderDisabled == true);
