...
{
    public class DataLabelFontColorFormatting : IIssueDataGenerator
    {
        ...
        { List<object> issueData = [];
            ...
            foreach (var vis in issueContext.ReportDocumentation?.VisualList ?? [])
            {
                try
                {
                    ...
                    if (inconsistentVis.ContainsKey(color))
                    {
                        inconsistentVis[color].Add(vis);
                    }
                    else
                    {
                        inconsistentVis.Add(color, [vis]);
                    }
                }
                catch (Exception ex)
                {
