...
{
    public class ButtonWithoutTooltip : IIssueDataGenerator
    {
        public SingleIssueRuleData GetData(IssueContext issueContext)
        {
            var tempIssueData = issueContext.ReportDocumentation?.ReportUIFormatting.StaticComponentsList.Where(x => x.VisualType == GlobalHandler.FormatVisualType("actionButton") && x.IsButtonToolTipDisabled == true);
